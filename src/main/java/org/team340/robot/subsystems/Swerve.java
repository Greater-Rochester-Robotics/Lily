...
public class Swerve extends GRRSubsystem {
    ...
    private static final SwerveModuleConfig FRONT_RIGHT = new SwerveModuleConfig()
        .setName("frontRight")
        .setLocation(0.27305, -0.27305)
        .setMoveMotor(SwerveMotors.sparkMax(RobotMap.FR_MOVE, MotorType.kBrushless, true))
    ...
    private static final SwerveModuleConfig BACK_RIGHT = new SwerveModuleConfig()
        .setName("backRight")
        .setLocation(-0.27305, -0.27305)
        .setMoveMotor(SwerveMotors.sparkMax(RobotMap.BR_MOVE, MotorType.kBrushless, true))
    ...
    private static final SwerveConfig CONFIG = new SwerveConfig()
        ...
        .setDriverProfile(4.0, 1.0, 4.2, 2.0)
